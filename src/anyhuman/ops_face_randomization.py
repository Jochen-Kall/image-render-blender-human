...
ignore_bones = {"eye_settings.R", "eye_settings.L"}

tongue_bone_name = "tongue_out_lt_rt_up_dwn"
eye_gaze_bone_name = "eyeball_lookat_master"

# face_marker_indices = { 'right_eye_0' : 3903, 'right_eye_1' : 3536, 'left_eye_0' : 891, 'left_eye_1' : 1088, 'between_eyes' : 1920}
...
def CheckForTongueIntersection():
...
def CorrectRandomTongueExpression(object, mLimits):
    ...
    if tongue_bone_name in object.pose.bones:
        tongueLimits = mLimits[tongue_bone_name]
        key = tongue_bone_name
        b = object.pose.bones[key]
...
def CorrectEyeGazeDirection(object):
    ...
    iVert0 = eye_left_center_vertex_idx
    iVert1 = eye_right_center_vertex_idx
    sBoneName = eye_gaze_bone_name
